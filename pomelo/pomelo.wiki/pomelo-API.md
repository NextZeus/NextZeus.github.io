...
#### Source
    ...
    Application.getBase = function() {  return this.get(Constants.Reserved.BASE);};
...
#### Source
    ...
    Application.globalFilter = function (filter) {  this.globalBefore(filter);  this.globalAfter(filter);};
